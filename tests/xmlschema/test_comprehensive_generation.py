...
class TestComprehensiveSchemaGeneration:
    ...
    def test_author_email_field_has_validator(self, generated_code: str):
        """Checks for the regex validator on the email field."""
        assert_field_definition_xml(
            generated_code, "email", "CharField",
    ...
    def test_author_status_enum_class_generated(self, generated_code: str):
        ...
        assert 'INACTIVE = "inactive", "inactive"' in generated_code
        assert 'DECEASED = "deceased", "deceased"' in generated_code
    ...
    def test_book_genre_enum_class_generated(self, generated_code: str):
        ...
        assert 'FICTION = "fiction", "fiction"' in generated_code
        assert 'NON_FICTION = "non-fiction", "non-fiction"' in generated_code
        assert 'SCIENCE_FICTION = "science-fiction", "science-fiction"' in generated_code
